<template>
  <nav class="fixed w-screen p-6 z-100">
    <div class="flex items-center justify-between">
      ...
      >
        <div @keydown.esc="isOpen = false" v-show="isOpen" class="z-100 fixed inset-0 transition-opacity">
      ...
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
          ...
          <li><button @click="navigate('/button')" class="my-4 inline-block">Button</button></li>
